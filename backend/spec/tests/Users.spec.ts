...
describe('Users Routes', () => {
  ...
  describe(`"GET:${getUsersPath}"`, () => {
    ...
    it(`should return a JSON object with all the users and a status code of "${StatusCodes.OK}" if the
    ...
    it(`should return a JSON object containing an error message and a status code of
            "${StatusCodes.BAD_REQUEST}" if the request was unsuccessful.`, (done) => {
  ...
  describe(`"POST:${addUsersPath}"`, () => {
    ...
    it(`should return a JSON object with an error message and a status code of "${StatusCodes.BAD_REQUEST}"
  ...
  describe(`"PUT:${updateUserPath}"`, () => {
    ...
    it(`should return a status code of "${StatusCodes.OK}" if the request was successful.`, (done) => {
    ...
    it(`should return a JSON object with an error message of "${paramMissingError}" and a
            status code of "${StatusCodes.BAD_REQUEST}" if the user param was missing.`, (done) => {
